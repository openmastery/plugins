...
import com.newiron.ideaflow.data.TimeBandOld
...
class TimelineController {
    ...
    def showTimeline() {
        ...
        timeline.timeBands << new TimeBandOld(Learning, new TimePosition(0, 0, 0), 70 * 60)
        timeline.timeBands << new TimeBandOld(Learning, new TimePosition(2, 51, 0), 104 * 60)
        timeline.timeBands << new TimeBandOld(Rework, new TimePosition(5, 30, 0), 20 * 60)
        timeline.timeBands << new TimeBandOld(Conflict, new TimePosition(5, 50, 0), 10 * 60)
        timeline.timeBands << new TimeBandOld(Conflict, new TimePosition(7, 30, 0), 24 * 60)
        timeline.timeBands << new TimeBandOld(Conflict, new TimePosition(8, 15, 0), 18 * 60)
        timeline.timeBands << new TimeBandOld(Conflict, new TimePosition(8, 43, 0), 11 * 60)
